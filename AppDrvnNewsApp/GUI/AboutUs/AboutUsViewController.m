...
@interface AboutUsViewController ()<AboutHeaderViewDelegate, MFMailComposeViewControllerDelegate>
...
- (void) layoutSetup
{
    ...
    self.bottomLabel.text = [NSString stringWithFormat:@"News Template v%@ coded by Appdrvn", currentVersion];
}
...
- (void) createData
{
    ...
    AboutUIModel *reference7 = [AboutUIModel AboutUIModelWithReferenceName:@"CarbonKit" referenceLink:@"https://github.com/ermalkaleci/CarbonKit" referenceAuthor:@"Ermal Kaleci"];
    AboutUIModel *reference8 = [AboutUIModel AboutUIModelWithReferenceName:@"NSDate+NVTimeAgo" referenceLink:@"https://github.com/nikilster/NSDate-Time-Ago" referenceAuthor:@"Nikil Viswanathan"];
    ...
    [self.dataArray addObjectsFromArray:@[reference1, reference2, reference3, reference4, reference5, reference6, reference7, reference8, reference9]];
    [self addHeaderView];
